...
import { b as fallbackCommittee } from "./settings-DwAPQC0V.js";
import { a as Route } from "./router-zUj7zh-c.js";
import "@directus/sdk";
import "react";
import "../server.js";
...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-cream-dim px-6 py-20 sm:px-8 lg:py-32", "aria-labelledby": "committee-heading", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
      ...
      /* @__PURE__ */ jsx("ul", { className: "mt-14 grid gap-x-8 gap-y-14 md:grid-cols-2 lg:grid-cols-3", children: committee.map((person, index) => /* @__PURE__ */ jsxs("li", { className: `group ${index % 3 === 1 ? "lg:translate-y-12" : index % 3 === 2 ? "lg:translate-y-4" : ""}`, children: [
        /* @__PURE__ */ jsxs("div", { className: "relative aspect-[4/5] overflow-hidden border-2 border-forest bg-cream shadow-[8px_8px_0_#16332c]", children: [
          /* @__PURE__ */ jsx(CommitteePortrait, { person, index }),
          /* @__PURE__ */ jsx("span", { className: "absolute right-4 top-4 rounded-full bg-cream px-3 py-1.5 text-xs font-extrabold uppercase tracking-wider text-forest", children: person.role_short || person.role })
        ] }),
