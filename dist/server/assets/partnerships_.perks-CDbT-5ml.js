...
import { l as submitPerksEnquiry } from "./router-zUj7zh-c.js";
...
const faqs = [["Is there a fee to join?", "No. There is currently no participation fee for BrightFutures Perks partners."], ["How much discount do we need to offer?", "There is no minimum. You choose an offer that works for your business."], ["Can the offer have restrictions?", "Yes. You can set reasonable terms such as specific days, times, products or minimum spend."], ["Can we change or withdraw an offer?", "Yes. Just let BrightFutures know so we can keep the listing accurate."], ["Who can use BrightFutures Perks?", "BrightFutures Perks is intended for eligible BrightFutures members. We are developing the member experience separately."], ["How will our business be promoted?", "Partners can be listed on BrightFutures.social and may also be featured through BrightFutures social media, communications and activities where appropriate."]];
function PerksPage() {
