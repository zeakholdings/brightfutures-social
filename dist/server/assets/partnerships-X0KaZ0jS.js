...
function PartnershipsPage() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-cream px-6 py-20 sm:px-8 lg:py-28", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-7xl", children: [
      /* @__PURE__ */ jsx("p", { className: "mb-10 max-w-3xl text-lg leading-relaxed text-forest/70 sm:mb-12", children: "We work with local businesses, charities, community organisations, University teams and others who can create useful opportunities for students." }),
      /* @__PURE__ */ jsx("div", { className: "grid gap-8 lg:grid-cols-2", children: routes.map(({
        title,
        body,
        icon: Icon,
        live
