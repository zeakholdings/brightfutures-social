...
import { h as Route } from "./router-tuXOV3p3.js";
...
function isUrgentHousingHelp(resource) {
  return resource.category === "accommodation" && `${resource.title} ${resource.context_label || ""}`.toLowerCase().includes("urgent");
}
function wellbeingAction(resource) {
...
function ResourceDetails({
  ...
  return /* @__PURE__ */ jsx("article", { className: urgentHousingHelp ? "relative border-2 border-coral bg-paper px-5 py-7 shadow-[6px_6px_0_#e8734a] sm:px-7 sm:py-8" : featured ? "relative border-t-2 border-forest bg-paper px-5 py-7 shadow-[6px_6px_0_#e8734a] sm:px-7 sm:py-8" : "border-t border-forest/20 py-7 first:border-t-0 sm:py-8", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-5 sm:grid-cols-[minmax(0,1fr)_10.5rem] sm:items-center sm:gap-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
      resource.context_label ? /* @__PURE__ */ jsx("p", { className: `mb-2 text-xs font-extrabold uppercase tracking-[0.12em] ${urgentHousingHelp ? "text-coral" : "text-forest/55"}`, children: resource.context_label }) : null,
    ...
    resource.url ? /* @__PURE__ */ jsxs("a", { href: resource.url, target: "_blank", rel: "noreferrer", className: "inline-flex w-fit items-center gap-2 bg-forest px-5 py-3.5 text-sm font-bold text-cream transition-transform hover:-translate-y-1 sm:w-full sm:justify-center", children: [
      urgentHousingHelp ? "Get urgent housing help" : actionLabel || "Visit resource",
      " ",
...
function ResourcesPage() {
  ...
  const audienceFilteredResources = selectedAudience ? resources.filter((resource) => resource.audience?.includes(selectedAudience) || selectedAudience !== "all-greenwich-students" && resource.audience?.includes("all-greenwich-students")) : resources;
  ...
  const startHerePriorities = ["urgent housing help", "accommodation for care-experienced", "greenwich cares", "gsu advice", "money advice", "spectrum life", "student wellbeing hub", "counselling and mental health", "report + support"];
  const startHereCandidates = [...startHerePriorities.map((term) => audienceFilteredResources.find((resource) => `${resource.title} ${resource.organisation || ""}`.toLowerCase().includes(term))), ...audienceFilteredResources.filter((resource) => resource.featured)].filter((resource) => !!resource).filter((resource, index, list) => list.findIndex((item) => item.id === resource.id) === index);
  const recommended = (selectedCategory ? startHereCandidates.filter((resource) => directoryCategory(resource) === selectedCategory) : startHereCandidates).slice(0, 5);
  ...
  const resultCount = selectedCategory ? audienceFilteredResources.filter((resource) => directoryCategory(resource) === selectedCategory).length : audienceFilteredResources.length;
  return /* @__PURE__ */ jsxs("div", { className: "overflow-hidden bg-cream", children: [
    /* @__PURE__ */ jsxs("section", { className: "relative bg-forest px-6 py-16 text-cream sm:px-8 sm:py-24 lg:py-28", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxs("div", { className: "max-w-4xl lg:w-[68%]", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-8 max-w-2xl text-lg leading-relaxed text-cream/78 sm:text-xl", children: "Money, housing, uni support, wellbeing and careers. We’ve pulled together the places that are actually worth knowing about." }),
    ...
    /* @__PURE__ */ jsx("section", { id: "resources-results", className: "scroll-mt-24 bg-cream px-6 py-16 sm:scroll-mt-28 sm:px-8 lg:py-24", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-7xl", children: !resources.length ? /* @__PURE__ */ jsxs("div", { className: "relative max-w-3xl border-l-4 border-coral py-3 pl-6 sm:pl-9", children: [
      ...
      startHereCandidates.length ? /* @__PURE__ */ jsxs("section", { "aria-labelledby": "start-here-heading", children: [
        /* @__PURE__ */ jsxs("div", { className: "border-b-2 border-forest pb-6", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: startHereCandidates.length ? "mt-20 lg:mt-28" : "", "aria-labelledby": "browse-heading", children: [
        /* @__PURE__ */ jsxs("div", { className: "border-b-2 border-forest pb-6", children: [
          /* @__PURE__ */ jsx("h2", { id: "browse-heading", className: "font-display text-5xl leading-none text-forest sm:text-6xl", children: "Browse all resources" }),
          /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-forest/62", "aria-live": "polite", children: selectedAudienceLabel ? `${resultCount} resource${resultCount === 1 ? "" : "s"} available to ${selectedAudienceLabel.toLowerCase()}${selectedLabel ? ` in ${selectedLabel.toLowerCase()}` : ""}.` : selectedLabel ? `Showing ${selectedLabel.toLowerCase()} resources.` : "Grouped by what you need." })
        ] }),
      ...
      /* @__PURE__ */ jsxs("aside", { className: "mt-12 border-t border-forest/20 pt-7 text-forest/70", "aria-labelledby": "not-sure-heading", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-2 max-w-3xl leading-relaxed", children: "BrightFutures can point you towards an appropriate service. We’re a student community and cannot provide emergency, counselling, housing, legal or financial advice." }),
