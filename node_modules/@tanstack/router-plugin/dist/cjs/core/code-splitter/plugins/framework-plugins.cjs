	...
	switch (opts.targetFramework) {
		case "react":
			if (opts.addHmr) return [
				require_react_refresh_ignored_route_exports.createReactRefreshIgnoredRouteExportsPlugin({ hotExpression: opts.hmrHotExpression }),
				require_react_refresh_route_components.createReactRefreshRouteComponentsPlugin(),
				require_react_stable_hmr_split_route_components.createReactStableHmrSplitRouteComponentsPlugin({ hotExpression: opts.hmrHotExpression })
			];
			return;
		default: return;
	}
