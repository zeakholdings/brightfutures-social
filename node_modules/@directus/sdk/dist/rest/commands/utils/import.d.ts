...
interface ImportBatchCollectionResult {
...
*/
declare const utilsImportBatch: <Schema>(data: FormData, options?: ImportBatchOptions) => RestCommand<ImportBatchResult, Schema>;
//#endregion
export { ImportBatchCollectionResult, ImportBatchOptions, ImportBatchResult, utilsImport, utilsImportBatch };
