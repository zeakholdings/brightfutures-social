...
*/
type SchemaSnapshotOptions<Schema> = {
  /**
...
*/
declare const schemaSnapshot: <Schema>(options?: SchemaSnapshotOptions<Schema>) => RestCommand<SchemaSnapshotOutput, Schema>;
//#endregion
export { SchemaSnapshotOptions, SchemaSnapshotOutput, schemaSnapshot };
