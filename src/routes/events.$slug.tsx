...
function EventPage() {
  ...
  const date = interestCheck ? "Help choose the date" : event.startDate ? new Intl.DateTimeFormat("en-GB", { dateStyle: "long", timeZone: "Europe/London" }).format(new Date(event.startDate)) : "To be confirmed"
