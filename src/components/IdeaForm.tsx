...
export function IdeaForm({ categories }: { categories: readonly string[] }) {
  ...
  return <form onSubmit={submit} className="grid gap-8"><div className="hidden" aria-hidden="true"><label>Website<input name="website" value={fields.website} onChange={change} tabIndex={-1} autoComplete="off"/></label></div>
